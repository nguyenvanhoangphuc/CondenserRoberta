...
import argparse
from utils import calculate_f2, japanese_tokenizer
# from config import Config

class Config:
    data_path = "zac2021-ltr-data-ja"
    save_bm25 = "saved_model_ja"
    top_k_bm25 = 2
    bm25_k1 = 0.4
    bm25_b = 0.6
...
if __name__ == '__main__':
    ...
    parser.add_argument("--data_path", default="zac2021-ltr-data-ja", type=str)
    ...
    if args.load_docs:
        ...
        for law_article in tqdm(data):
            ...
            for sub_article in law_articles:
                ...
                tokens = japanese_tokenizer(article_full)
                print(tokens)
    ...
    for idx, item in tqdm(enumerate(items)):
        ...
        tokenized_query = japanese_tokenizer(question)
        ...
        # Trick to balance precision and recall   #2.7
