...
if __name__ == '__main__':
    ...
    parser.add_argument("--save_path", default="pair_data_ja", type=str)
    parser.add_argument("--top_k", default=20, type=int, help="top k hard negative mining")
    parser.add_argument("--path_doc_refer", default="saved_model_ja/doc_refers_saved", type=str, help="path to doc refers")
    parser.add_argument("--path_legal", default="generated_data_ja/legal_dict.json", type=str, help="path to legal dict")
