...
def main():
    ...
    # phân tích các đối số dòng lệnh từ trong các class của file arguments.py và có thể lấy ra sử dụng được
    # đọc thành 3 bộ tham số là model_args, data_args, training_args
    ...
    # Kiểm tra các thư mục đầu ra có tồn tại không, nếu tồn tại và không rỗng thì thông báo lỗi
    if (
    ...
    # load dataset from file train_path, validation_file
    ...
    # khởi tạo tokenizer từ tên hoặc đường dẫn tokenizer_name hoặc model_name_or_path
